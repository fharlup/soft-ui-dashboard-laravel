      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">buat akun untuk menggunakana aplikasi ini.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="NIK" name="NIK" id="NIK" aria-label="NIK" aria-describedby="NIK-addon">
                  @error('NIK')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="alamat" name="alamat" id="alamat" aria-label="alamat" aria-describedby="alamat-addon">
                  @error('alamat')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="form-check form-check-info text-left">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    setuju dengan <a href="javascript:;" class="text-dark font-weight-bolder">pertaturan perusahaan</a>
                  </label>
                  @error('agreement')
                  @enderror
                </div>
                ...
                <p class="text-sm mt-3 mb-0">sudah memilki akun ? <a href="login" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
